...
the state of the inhomogeneous matter density and the time-dependence of dark energy. Cosmic shear studies are hurdled by a number of statistical uncertainties (unknown distribution 
...
Modeling galaxy clustering with the halo models follows two central assumptions. First, galaxies form in virialized regions of 
...
the positions and velocities of galaxies are distributed within a halo. This simple assumption has been useful 
in reproducing the observed statistics of galaxies.

Despite being successful at reproducing a wide range of the observed statistics of galaxies, HOD remains agnostic about assembly bias.
Assembly bias, a phenomenon seen in simulations, has not certainly been confirmed with observations.
According to halo assembly bias, at a fixed halo mass, clustering of halos depend on halo properties beyond mass.
There are very mixed results in the literature.

By weak lensing analysis of the galaxy groups in GAMA (GAlaxy and Mass Assembly, see \citet{driver}) 
with the KiDS (Kilo Degree Survey, see \citet{kuijken2015}) imaging data, \citet{dvornik} find no evidence for halo assembly bias.
...
\citep{miyatake2016} claimed strong difference between the bias of two populations of clusters with different radial distribution of satellite galaxies 
...
The effect of assembly bias on galaxy clustering can be seen in many subhalo abundance matching (SHAM, see \citet{hearin2014,lehman2015} and references therein) methods. SHAM assumes a one-to-one relation between halo (including subhalos) properties (\eg\ mass, circular velocity) and some galaxy properties (\eg\ stellar mass, luminosity). In Chapter 3, with the clustering measurements of SDSS DR7 main sample of galaxies \citep{abazajian2009} and the Small MultiDark $N$-body simulation, we show that the clustering predictions of \citep{decorated} HOD model are consistent with the predictions of the \emph{mass-only} HOD model within 1-$\sigma$ level. 
...
We note that in terms of the effect of halo assembly bias on galaxy clustering, our constraints show qualitatively behavior in comparison with the predictions of subhalo abundance matching models. Unlike the findings of \citet{zentner2016} we do not find any evidence for assembly bias in the satellite population of galaxies.
...
The galaxy-galaxy lensing signal of SDSS III/BOSS \citep{miyatake15,lensingislow} are not consistent with the predictions of best-fit Planck cosmology \citep{planckII}.
...
Disagreements hold for the cosmological constraints---assuming a simple mass only HOD model---from the clustering and galaxy-galaxy lensing measurements of SDSS DR7 main sample \citep{more13}. These discrepancies could signal a new physics, observational systematics, or uncertainties arising from the galaxy formation physics, including \emph{assembly} \emph{bias}.
