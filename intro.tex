...
by the CMB experiments such as WMAP \citep{benntet2013}, Planck \citep{planckII}, 
...
Perturbations in the baryon-phone plasma of the early universe did not grow via gravitational instability. 

Acoustic oscillations in the early universe baryon-photon plasma resulted in a sound wave 
that froze after the epoch of recombintation and leaves an imprint with a characteristic scale on the perturbations 
in late time universe \citep{eisenstein1998}. 

Therefore the BAO provides a highly accurate estimate of the angular diameter 
