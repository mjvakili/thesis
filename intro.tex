...
With the observations of the cosmic microwave background radiation 
and the distant Type Ia supernovae, our understanding of universe was revolutionized in the late 90s. 
By analyzing the key CMB datasets, we now know that the universe was in a very hot uniform state with the 
random fluctuations around the uniform background. By measuring the brightness of SNe Ia, we have learned 
that these SNe Ia are dimmer that what expected in a matter dominated expanding universe. Further investigations 
have led us to believe that the late universe is undergoing an accelerated expansion.

Mention BAO feature, redshift space distortion, weak lensing, .... . Mention that by combining probes, we are going to reach percent level precision on ....
This ambitious goal 
